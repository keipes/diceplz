...
interface TTKChartFullAutoProps {
...
const damageToTTK = function(weapon: WeaponData, damage: number) {
    ...
    return Math.round((1000 / (weapon.rpm[2] / 60)) * (btk - 1));
}

function TTKChartFullAuto(props: TTKChartFullAutoProps) {
...
export default TTKChartFullAuto
