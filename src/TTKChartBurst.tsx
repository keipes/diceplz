...
const damageToTTK = function(weapon: WeaponData, damage: number) {
    ...
    return Math.round((1000 / (weapon.rpm[1] / 60)) * (btk - 1));
}

function TTKChartBurst(props: TTKChartBurstProps) {
